<#
    Source code from: https://unrealcontainers.com/blog/enabling-vendor-specific-graphics-apis-in-windows-containers/
#>
...
if ($amdSentinelFile) {
	...
	Write-Host "`nAMD graphics APIs not found!!!"
}
...
if ($nvidiaSentinelFile) {
	...
	Write-Host "`nNVIDIA graphics APIs not found!!!"
}